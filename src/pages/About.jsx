...
import { SiReact, SiJsonwebtokens, SiSocketdotio, SiTailwindcss } from "react-icons/si";
...
<div className="max-w-3xl text-gray-700 text-lg sm:text-xl leading-relaxed space-y-6 px-0 py-0">
  ...
  <p className="opacity-90 hover:opacity-100 transition-opacity duration-500">
    I specialize in the <span className="font-semibold text-indigo-600">MERN stack</span> and build full-stack apps with features like <span className="italic">JWT authentication</span>, <span className="italic">real-time chat</span>, secure uploads, and role-based access.
  </p>
  <p className="opacity-90 hover:opacity-100 transition-opacity duration-500">
